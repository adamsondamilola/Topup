...
//                    console.log(x)
    ...
    <div class="container-full">
                      ...
                      <div class="box-body">
                          <div class="row mb-20">
                            ...
                            <table class="table mb-0">
                              ...
                              {network == "Bank"? <tr>
                                <th><a href="javascript:void(0)">Convenience Fee</a></th>
      ...
      className='form-control'/></th>
                             ...
                             <div class="row">  
                             <div className='col-lg-12 m-3'>Where do you want to Transfer or convert your earnings to? Select an option below</div>      
        {services.map(x =>
