...
const BuySMEData = () => {
    ...
    const verifyInput = () => {
        ...
        var selected_network = dataBillingList.filter(x => x.data_code == network)
              ...
              <div class="col-xl-12 col-12">
                  <div class="box position-static">
                      <div class="box-header">
                          <h4 class="box-title">SME Data</h4>
                          </div>
                      <div class="box-body">
                          <div class="row mb-20">
                            ...
                            <table class="table mb-0">
                                ...
                                <img src={logos.mtn} style={style.logo} />
                                </td>
                              </tr>
                                <tr>
