...
Route::group([
    ...
    function()
    {
        ...
        Route::post('verify_pin', [AuthController::class, 'verify_pin']);
        Route::get('logged/user', [AuthController::class, 'ifLoggedIn']);
                ...
                Route::group([
                    ...
                    function()
                    {
                      ...
                      Route::post('buy_data', [AirtimeRechargeController::class, 'buy_none_sme_data']);
                        ...
                        Route::get('{id}/get_airtime_details', [AirtimeRechargeController::class, 'get_airtime_details']);
                        Route::get('{token}/{id}/get_airtime_details_public', [AirtimeRechargeController::class, 'get_airtime_details_public']);
                        Route::get('get_airtime_list', [AirtimeRechargeController::class, 'get_airtime_list']);
                        Route::get('{network}/get_airtime_list', [AirtimeRechargeController::class, 'get_airtime_list_by_network']);
