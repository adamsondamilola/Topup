...
class AdminSettingsController extends Controller
{
    ...
    public function listAdmin(Request $request){
      ...
      public function makeAdmin(Request $request, $username){
        $token_check = $this->check_login_token();
        if($token_check != 0)
        {
          $user = DB::table('users')
...
public function FreeUsersCommissionDetails(Request $request){
    $token_check = $this->check_login_token();
    if($token_check != 0)
    {
        $admin = DB::table('users')
...
//delete data service
public function deleteDataService(Request $request, $id){
    $token_check = $this->check_login_token();
    if($token_check != 0)
    {
...
public function deleteElectricityService(Request $request, $id){
    $token_check = $this->check_login_token();
    if($token_check != 0)
    {
...
public function deleteCableService(Request $request, $id){
    $token_check = $this->check_login_token();
    if($token_check != 0)
    {
...
public function airtime_pins(Request $request, $num){
    $token_check = $this->check_login_token();
    if($token_check != 0)
    {
        $user = DB::table('users')
...
public function admin_airtime_pins(Request $request, $num){
    $token_check = $this->check_login_token();
    if($token_check != 0)
    {
        $user = DB::table('users')
...
public function search_airtime_pins(Request $request, $search){
    $token_check = $this->check_login_token();
    $user_id=$token_check;
...
public function admin_search_airtime_pins(Request $request, $search){
    $token_check = $this->check_login_token();
    $user_id=$token_check;
