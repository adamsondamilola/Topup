...
class AdminController extends Controller
{
  ...
  public function package_coupons(Request $request){
  ...
  public function search_coupon(Request $request, $coupon){
...
//          'amount' => 'required|numeric',
  ...
  public function wallet_coupons(Request $request){
  ...
  public function site_stats(Request $request){
  ...
  public function airtimePrintAmountStats(Request $request){
  ...
  public function availableAirtimeStats(Request $request, $network){
  ...
  public function usedAirtimeStats(Request $request, $network){
...
public function search_user(Request $request, $username){
...
public function transactions(Request $request, $username, $num){
  $token_check = $this->check_login_token();
  if($token_check != 0)
  {
      $admin = DB::table('users')
...
public function transfer_transactions(Request $request, $username, $num){
    $token_check = $this->check_login_token();
    if($token_check != 0)
    {
        $admin = DB::table('users')
...
public function deactivate_activate_account(Request $request, $username){
  $token_check = $this->check_login_token();
  if($token_check != 0)
  {
    $user = DB::table('users')
...
public function payment_approval(Request $request, $id, $status){
    $token_check = $this->check_login_token();
    if($token_check != 0)
    {
  ...
  public function bank_withdrawal_transactions(Request $request, $num){
    $token_check = $this->check_login_token();
    if($token_check != 0)
    {
        $admin = DB::table('users')
...
public function upgrade_downgrade(Request $request, $username){
...
public function reset_pin(Request $request, $username){
  $token_check = $this->check_login_token();
  if($token_check != 0)
  {
    $validator = Validator::make($request->all(), [
...
public function chats(Request $request, $chat_type){
...
else if($chat_type == "closed")
{
  ...
  public function open_chats(Request $request, $phone){
    $token_check = $this->check_login_token();
    if($token_check != 0)
    {
        $user = DB::table('users')
  ...
  public function open_chats_by_message_id(Request $request, $messageId){
    $token_check = $this->check_login_token();
    if($token_check != 0)
    {
        $user = DB::table('users')
  ...
  public function opened_chat_details(Request $request, $messageId){
    $token_check = $this->check_login_token();
    if($token_check != 0)
    {
        $user = DB::table('users')
